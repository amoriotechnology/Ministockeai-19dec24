...
<style>
   ...
   .panel-body{
   background: #ffffff;insert_purchase1
   }
   .box {
   position: relative;
   background: #ffffff;
            ...
            <div class="panel panel-bd lobidrag">
               <div class="panel-heading">
                  <div class="panel-body">
                     ...
                     <div id='product_supplier' class="without_po">
                        ...
                        <form id="insert_purchase1"  method="post">
                           ...
                           <div class="table-responsive">
                              ...
                              <table class="table table-bordered table-hover"  style="border:2px solid #d7d4d6;" >
                                 ...
                                 <tr>
                                    ...
                                    <td  style="width:12%;"><a href="#" class="client-add-btn btn btnclr" aria-hidden="true" style="color:white; margin-right: 295px;"  data-toggle="modal" data-target="#expensetax_info" ><i class="fa fa-plus"></i></a></td>
                                 </tr>
                              </table>
                              ...
                              <table class="table table-bordered table-hover  "  style="border:2px solid #d7d4d6;" >
                                 ...
                                 <tr>
                                    ...
                                    <td colspan="3" style="width:150px;text-align:right;border:none;"><b><?php  echo display('TAX DETAILS');?> :</b></td>
                                    <td colspan="1" style="border:none;width:400px;">  <span class="input-symbol-euro">     <input type="text" class="form-control" style="width:150px;"  id="tax_details" value="0.00" name="tax_details"  readonly="readonly" /></span></td>
                                 </tr>
                                 <tr>
                                 ...
                                 <tr    style="height:50px" >
                                    ...
                                    <td colspan="1" style="border:none;"></td>
                                    <td class="amt" colspan="3"  style="vertical-align:top;text-align:right;border:none;"><b><?php echo display('balance_ammount');  ?> :</b></td>
                           ...
                           <div class="row">
                              <div class="col-sm-12">
                                 <div class="form-group row">
                                    <label for="adress" class="col-sm-2 col-form-label" style="margin-left:44px;" ><?php echo  display('Remarks / Details');?>
                                    </label>
                                    <div class="col-sm-7">
                           ...
                           <div class="row">
                              <div class="col-sm-12">
                                 <div class="form-group row">
                                    <label for="adress" class="col-sm-2 col-form-label" style="margin-left:44px;" ><?php echo  display('Message on Invoice');?>
                                    </label>
                                    <div class="col-sm-7">
                     ...
                     <div class='serv_provider' id="service_provider_data">
                        <div class="panel-body">
                              ...
                              <div class="row">
                                 ...
                                 <div class="col-sm-6">
                                    <div class="form-group row">
                                       ...
                                       <div class="col-sm-8">
                                          <input type="text" tabindex="3" class="form-control" name="sp_address" style="border:2px solid #d7d4d6;"  id="sp_address"  />
                                       </div>
                                    </div>
                                 </div>
                              </div>
                                 ...
                                 <table class="cscheTable  table table-bordered table-hover serviceprovider" id="service_1" style="border:2px solid #d7d4d6;" >
                                    ...
                                    <tbody id="servic_pro">
                                       <tr>
                                          <td class="span3 supplier">
                                             <input type="hidden" name="tableid[]" id="tableid_1"/>
                                             <input  list="magicHouses" type="text"   tabindex="2" class="acc_name form-control " name="product_name[]"  id="product_name"/>
                                             <datalist id="magicHouses">
                                                <?php 
                                                   foreach($product_list as $tx){?>
                                                <option value="<?php echo $tx['product_name'].'-'.$tx['product_model'];?>">  <?php echo $tx['product_name'].'-'.$tx['product_model'];  ?></option>
                                          ...
                                          <td class="wt">
                                             <input type="text" name="description_service[]" id="description_1"   min="0" class="form-control text-right store_cal_1"   placeholder="" value=""  tabindex="6"/>
                                          </td>
                                          <td class="text-right">
                                    ...
                                    <tfoot>
                                       ...
                                       <table class="taxtab table table-bordered table-hover"   style="border:2px solid #d7d4d6;" >
                                          <tr>
                                             ...
                                             <td  style="width:12%;"><a href="#" class="btnclr client-add-btn btn " aria-hidden="true" style="margin-right: 295px;"  data-toggle="modal" data-target="#expensetax_info" ><i class="fa fa-plus"></i></a></td>
                                          </tr>
                                       </table>
                                       <input type="hidden" id="paid_convert" name="paid_convert"/>   <input type="hidden" id="bal_convert" name="bal_convert"/>
                        ...
                        <div class="col-sm-5">
                           <table border="0">
                              <tr>
                                 ...
                                 <td> <span class="input-symbol-euro"><input  type="text"  readonly name="amount_to_pay" id="amount_to_pay"   style="width:117%;" class="gtotal form-control" required   /></td>
                              </tr>
                           </table>
                        </div>
                     </div>
                     <div class="form-group row" style="display:none;">
                        ...
                        <div class="col-sm-5">
                           <table border="0">
                              <tr>
                                 <td class="cus" name="cus"> </td>
                                 <td> <span class="input-symbol-euro"><input  type="text"  readonly name="amount_received" style="width:117%;"  id="amount_received" class="form-control"required   /></td>
                              </tr>
                           </table>
                        </div>
                     </div>
                     <div class="form-group row">
                        <label for="billing_address"  style="text-align: start;width: 30%;margin-left: 85px;"    class="col-sm-3 col-form-label"><?php  echo display('balance_ammount'); ?> </label>
                        <div class="col-sm-5">
                           <table border="0">
                              <tr>
                                 <td class="cus" name="cus"> </td>
                                 <td> <span class="input-symbol-euro"><input  type="text"   readonly name="balance_modal"  style="width:117%;" id="balance_modal" class="form-control" required  /></td>
                              </tr>
                           </table>
                        </div>
                     </div>
                     <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                           <table border="0">
                              <tr>
                                 <td class="cus" name="cus"></td>
                                 <td> <span class="input-symbol-euro"><input  type="text"   name="payment" id="payment_from_modal"  style="width:117%;" class="form-control"required   /></td>
                              </tr>
                           </table>
                        </div>
                     </div>
...
<script type="text/javascript">
   ...
   $('#serviceprovider').submit(function(e) {
              var form_data = new FormData();
            //  var formData = new FormData($('form')[0]);
            form_data.append('<?php echo $this->security->get_csrf_token_name(); ?>', '<?php echo $this->security->get_csrf_hash(); ?>');
            //   form_data.append('invoice_no', document.getElementById('invoice_no').value);
        //    form_data.append('csrfName', '{{ csrfHash }}');
              var ins = document.getElementById('attachment_services').files.length;
              for (var x = 0; x < ins; x++) {
                  form_data.append("files[]", document.getElementById('attachment_services').files[x]);
              }
              $.ajax({
                  url: '<?php echo base_url(); ?>Cpurchase/serviceprovider_file_upload', 
   ...
   success: function(result, statut) {
    ...
    $("#balance").val(result[0]['balance'].toFixed(2));
      console.log(result);
   }
   });
   }
                  ...
                  <div class="form-group row">
                     ...
                     <div class="col-sm-5">
                        <table border="0">
                           <tr>
                              <td class="cus" name="cus">   </td>
                              <td><span class="input-symbol-euro"><input  type="text"  readonly name="amount_to_pays" id="amount_to_pays"   style="width:119%;" class="form-control" required   /></td>
                           </tr>
                        </table>
                     </div>
                  </div>
                  <div class="form-group row" style="display:none;">
                     ...
                     <div class="col-sm-5">
                        <table border="0">
                           <tr>
                              <td class="cus" name="cus">   </td>
                              <td><span class="input-symbol-euro"><input  type="text"  readonly name="amount_received" style="width:119%;"  id="amount_received" class="form-control"required   /></td>
                           </tr>
                        </table>
                     </div>
                  </div>
                  <div class="form-group row">
                     ...
                     <div class="col-sm-5">
                        <table border="0">
                           <tr>
                              <td class="cus" name="cus">  </td>
                              <td><span class="input-symbol-euro"><input  type="text"   readonly name="balance_modals"  style="width:119%;" id="balance_modals" class="form-control" required  /></td>
                           </tr>
                        </table>
                     </div>
                  </div>
                  <div class="form-group row">
                     ...
                     <div class="col-sm-5">
                        <table border="0">
                           <tr>
                              <td class="cus" name="cus">   </td>
                              <td><span class="input-symbol-euro"><input  type="text"   name="payment_from_modals" id="payment_from_modals"  style="width:119%;" class="form-control"required   /></td>
                           </tr>
                        </table>
                     </div>
                  </div>
