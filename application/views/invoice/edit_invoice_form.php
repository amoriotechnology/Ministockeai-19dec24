       ...
       <div class="row">
         <div class="col-sm-12">
            <div class="panel panel-bd lobidrag"   style="border: 3px solid #d7d4d6;" >
                        ...
                        <div class="col-sm-6" id="payment_from_1">
                           <div class="form-group row">
                              <label for="customer_name" class="col-sm-4 col-form-label"><?php
                                 ...
                                 ?>  </label>
                              <div class="col-sm-8">
                                 <input type="text"  name="customer_name" id="customer_name"  placeholder='Customer Name'   value="<?php echo $customer_id; ?>"  class="form-control customer_name" style="border:2px solid #d7d4d6;"  >
                              </div>
                           </div>
                        </div>
                     ...
                     <div class="row">
                        <div class="col-sm-6">
                           <div class="form-group row">
                              ...
                              <div class="col-sm-8">
                                 <input class=" form-control" type="text" size="50" name="billing_address" style="border: 2px solid #d7d4d6;" placeholder='Billing Address'  value= "<?php  echo $billing_address ; ?>"  id="billing_address"  />
                              </div>
                           </div>
                           <div class="form-group row">
                              <label for="phone_no" class="col-sm-4 col-form-label"><?php echo ('Phone No') ?></label>
                              <div class="col-sm-8">
                                 <input class="form-control" placeholder="Container Number" type="number" size="50" name="phone_no" id="phone_no"  style="border: 2px solid #d7d4d6;"   value= "<?php  echo $container_no ; ?>" tabindex="4" />
                              </div>
                           </div>
                        </div>
                        <div class="col-sm-6">
                           ...
                           <div class="form-group row">
                              <label for="payment_type" class="col-sm-4 col-form-label"><?php
                                 ...
                                 ?> </label>
                              <div class="col-sm-8">
                                 <input type="text" name="payment_type" style="border: 2px solid #d7d4d6;" placeholder="Payment Type"   value= "<?php  echo $paytype; ?>"  class="form-control">
                              </div>
                           </div>
                        </div>
                     </div>
               ...
               <table class="table  cscheTable table-bordered normalinvoice table-hover" id="normalinvoice_<?php  echo $m; ?>" style="border: 2px solid #d7d4d6;" >
               <thead>
               <tr>
               <th  class="text-center"  style="width:400px;" ><?php echo display('product_name') ?>   &nbsp;&nbsp; </th>
               <th    class="text-center" style="width:546px;" ><?php echo display('Description') ?></th>
               <th   class="text-center" style="width:291px;" ><?php echo  ('Quantity') ?> 
               &nbsp; &nbsp; &nbsp; &nbsp;
                               <select name="unit" required>
                               <option value="Sq.Ft" <?php echo $unit == 'Sq.Ft' ? 'selected' : ''; ?>>Sq.Ft</option>
                               <option value="inches" <?php echo $unit == 'inches' ? 'selected' : ''; ?>>inches</option>
                               <option value="Cms" <?php echo $unit == 'Cms' ? 'selected' : ''; ?>>Cms</option>
                               <option value="Nos" <?php echo $unit == 'Nos' ? 'selected' : ''; ?>>Nos</option>
                              </select>
               </th>


               <th    class="text-center" style="width:150px;"><?php echo ('Rate') ?></th>
               <th     class="text-center" style="width:136px;"><?php echo display('total') ?></th>
               ...
               <td >
               <input type="text" name="thickness[]" id="thickness_<?php  echo $m.$n; ?>"   value="<?php  echo $inv['thickness'];  ?>" class="thickness form-control"/>
               </td>
               <td >
               <input type="text"  id="supplier_s_no_<?php  echo $m.$n; ?>" name="supplier_slab_no[]"   value="<?php  echo $inv['supplier_slab_no'];  ?>" class="supplier_slab_no form-control"/>
               </td>
               <td >
               <input type="hidden" id="net_height_<?php  echo $m.$n; ?>" name="net_height[]"       class="net_height form-control" />
               <span class="input-symbol-euro"><input  type="text" class="sum_amount form-control" style="width:100px;"     id="total_<?php  echo $m.$n; ?>"    value="<?php  echo $inv['total_price'];  ?>"  name="total_price[]"/></span>
               </td>  
               ...
               <td></td>
               <td >
               <span class="input-symbol-euro">     <input type="text"   name="total"   value="<?php  echo $inv['total_amount'];  ?>" class="ov_total form-control"   style="padding-top: 6px;width:100px"    readonly="readonly"  />
               </td>
               ...
               <td style="width:12%">
               <input list="magic_tax" name="tax_details"  id="product_tax" value="<?php  echo $t; ?>" class="form-control"   onchange="this.blur();" />
               ...
               <td  colspan="1" style="border:none;">  <span class="input-symbol-euro">     <input type="text" class="form-control" style="width:150px;"    value="<?php echo $tax_details;  ?>" name="tax_details"  id="tax_details"  readonly="readonly" /></span></td>
               </tr>
               <tr>    
               <td   style="text-align:right;border:none;display: none;"><b>  <?php echo display('GRAND TOTAL') ?> :</b></td>
               ...
               <td  colspan="1" style="border:none;">  <span class="input-symbol-euro"><input type="text" class="alreadyaddcost form-control" style="width:150px;" id="landing_amount" name="landing_cost"  readonly="readonly" /></span></td>
               </tr>
               ...
               <td colspan="1" style="border:none;">  <span class="input-symbol-euro">    <span class="input-symbol-euro">   <input type="text" id="gtotal"   class="gtotal form-control" style="width:150px;" name="gtotal" value="<?php echo $all_invoice[0]['gtotal'];  ?>"  readonly="readonly" /></td>
               </tr>
               <tr>    
               </tr>
              ...
              <tr class="amt">
               ...
               <td><span class="input-symbol-euro amount_paidcss">  <input  type="text" style="width:150px;margin-top: 6px;"  value="<?php echo $all_invoice[0]['paid_amount']; ?>"  readonly   id="amount_paid" class="amount_paid form-control"   name="amount_paid"  required   /></td>
               </tr>
               </table>
               ...
               <span class="input-symbol-euro"> <input  type="text"  class="balance form-control"  style="width:150px;" readonly id="balance" value="<?php echo $all_invoice[0]['due_amount']; ?>"  name="balance"  required   />                     
               </td>     </tr>
               </table>
               </td>
               </tr>
               ...
               <input type="submit" value="<?php echo "Additional Cost"; ?>"   class="btnclr btn btn-large click_add" id="landing_cost"/>
               <input type="button" value="<?php echo  ('Receive  Payment') ?>"   class="btnclr paypls btn btn-large" />
               </td>
               </tr>
               </tfoot>
               </table>
               ...
               <div class="col-sm-8">
               <textarea rows="2" cols="50" id="details" name="ac_details"     style="border: 2px solid #d7d4d6;    width: 258%;"   class=" form-control"  ><?php   if(!empty($ac_details)){echo trim($ac_details);} ?></textarea>
               </div>
               </div>
               <div class="form-group row">
               <label for="remark" class="col-sm-4 col-form-label"><?php echo display('Remarks/Conditions') ?></label>
               <div class="col-sm-8">
               <textarea rows="2" cols="110" id="remarks" name="remark" style="border: 2px solid #d7d4d6;    width: 258%;"  class=" form-control"    ><?php   if(!empty($remark)){echo trim($remark);} ?></textarea>                                      
               </div>
               </div>
               </div>
               <tr>
               ...
               <a    id="final_submit" style="margin-left:20px;"  class='btnclr final_submit btn'> <?php echo display('submit') ?></a>
               </td>
        ...
        <?php echo  ('Print') ?>
               ...
               <div class="modal-content" style="width: 1500px;margin-top: 190px;text-align:center;">
                  ...
                  <div class="modal-body">
                     <form id="land_form" method="post">
                        <input type="hidden" name="<?php echo $this->security->get_csrf_token_name();?>" value="<?php echo $this->security->get_csrf_hash();?>">
                        <table class="service_1 serviceprovider table table-bordered" id="service_1">
                           <thead>
                           ...
                           <tbody id="service_pro">
                              ...
                              <tr>
                                 <td style="text-align:center;">
                                    <input type="hidden" id="dum_invoice" class="dum_invoice" value= "<?php  echo $additional_cost[0]['commercial_invoice_number'] ; ?>" name="dum_invoice"/>
                                 ...
                                 <td style="text-align:center;"><input type="text" id="sp_description_<?php  echo $j; ?>" value="<?php  echo $ac_cost['Description'] ; ?>"  class="sp_description form-control" name="sp_description[]"/></td>
                                  ...
                                  <td style="display: none;"><input type="hidden" id="SERVICE_ID" class="SERVICE_ID" value="<?php  echo $ac_cost['id'] ; ?>"   /></td>
                                 ...
                                 <td style="text-align:center;">
                                    ...
                                    &nbsp;<button class='delete_provider btn btn-danger btn-sm delete_service' type='button' value='Delete'><i class="fa fa-trash"></i></button>
                                 </td>
                              </tr>
                              <?php 
                                 $j++;
                              ...
                              <tr>
                                 ...
                                 <td style="text-align:center;"><input type="text" id="sp_description_<?php  echo $j; ?>" class="sp_description form-control" name="sp_description[]"/></td>
                                 <td style="text-align:center;"><input type="text" id="sp_qty_<?php  echo $j; ?>" class="sp_qty form-control" name="sp_qty[]"/></td>
                                 <td style="text-align:center;"><input type="text" id="sp_rate_<?php  echo $j; ?>" class="sp_rate form-control" name="sp_rate[]"/></td>
                                 <td style="text-align:center;"><input type="text" readonly id="sp_total_<?php  echo $j; ?>" class="form-control sp_total"  name="sp_total[]"/></td>
                                 <td style="text-align:center;">
                                    <button class='btn-cSche add addServiceButton btn btnclr btn-sm' type='button' value='Add Row'><i class="fa fa-plus"></i></button>
                           ...
                           <tfoot>
                              <tr>
                                 ...
                                 <td colspan="0" ><input type="text" name="overall_total" id="landing_amount" readonly class="form-control overall_total" style="float: left;"/></td>
                              </tr>
                              <tr>
                                 <td colspan="4"></td>
                        ...
                        <div class="row">
                           <div class="form-group row">
                            ...
                            <div class="form-group row">
                             ...
                             <div class="col-sm-5">
                                <input class=" form-control" type="text" name="m_payment" id="m_payment" value="<?php  echo $paytype; ?>" />
                             </div>
                            </div>
                           <input type="hidden" id="cutomer_name" name="cutomer_name"/>
                           
                           <input type="hidden"  value="<?php if($all_invoice[0]['payment_id']){ echo $all_invoice[0]['payment_id']; }else{ echo $payment_id_new;}?>" name="payment_id" class="editpayment_id" id="editpayment_id"/>
                           <div class="form-group row">
                           ...
                           <div class="form-group row" style="display:none;">
                              ...
                              <div class="col-sm-5">
                                 <input  type="text"  readonly name="amount_received" id="amount_received" class="form-control" required   />
                              </div>
                           </div>
                           <div class="form-group row">
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-sm-5">
                                 <table border="0">
                                   <tr>
                                      <td class="cus" name="cus"></td>
                                      <td><span class="input-symbol-euro"><input  type="text"   name="payment" id="payment_from_modal"  style="width:230px;" class="form-control"required /></span></td>
                                   </tr>
                                </table>
                              </div>
                           </div>
         ...
         <script>
            $(document).ready(function() {
                ...
                $(document).on('input', '.sum_amount', function() {
                    sum = 0; // Reset sum on every input
            
                    $(this).closest('table').find('.sum_amount').each(function() {
                        var v = $(this).val();
                        sum += parseFloat(v) || 0; // Ensure parseFloat returns a number or default to 0
                    });
            
                    var totalInput = $(this).closest('table').find('.ov_total');
                    totalInput.val(sum.toFixed(2));
            
                    // Update the total amount in the specific input field with class 'ov_total'
                    $('.ov_total').val(sum.toFixed(2));
                });
            });
...
<script type="text/javascript">
   ...
   $(".add").on("click", function () {
    var newRow = "<tr>";
    newRow += '<td><input type="text" name="prodt[]" class="form-control" value="" /></td>';
    newRow += '<td><input type="text" name="description[]" class="form-control" value="" /></td>';
    newRow += '<td><input type="text" name="thickness[]" class="thickness form-control"  value="" /></td>';
    newRow += '<td><input type="text" name="supplier_slab_no[]" class="supplier_slab_no form-control"  value="" /> </td>';
    newRow += '<td><span class="input-symbol-euro"><input class="form-control sum_amount"  style="width:100px;" form-control mobile_price" type="text" readonly id="total"  value=""  name="total_price[]" placeholder="0.00" /></span></td>';
       ...
       $.ajax({
           ...
           success:function (data) {
            ...
            var amtpd=parseFloat(data.amt_paid);
             ...
             if (!isNaN(amtpd) && amtpd !== 0) {

                    var bal= parseFloat(gt -  amtpd);
...
//   var GTOTAL = $('.gtotal').val(total.toFixed(2)); 
  ...
  var AdditionalCost=0;
   if($('.alreadyaddcost').val() >0){
   AdditionalCost = parseFloat($('.alreadyaddcost').val());
   var la=$('.alreadyaddcost').val();
  // $('#gtotal').val(parseFloat(gtotal+la));
}else{
  $('.alreadyaddcost').val('0.00');
}

         if (!isNaN(AdditionalCost) && AdditionalCost !== 0) {

        //     var applandValue = $('.alreadyaddcost').val(); 
        //     console.log("applandValue: ", applandValue);
        //     var totalSum =  $('#gtotal').val() + applandValue; 
        //     // alert(totalSum);
        //     $('.gtotal').val(totalSum.toFixed(2)); 
        //  } else {
        //      $('.gtotal').val(gtotal); 
        //   //  $('.landing_amount').val('0.00'); 
        //  }
       
             var gtotalValue = parseFloat($('#gtotal').val());
             var applandValue = parseFloat($('.alreadyaddcost').val());
             if (isNaN(gtotalValue)) {
             console.error('Invalid value for gtotal');
             gtotalValue = 0; // or handle it in some way
             }
             if (isNaN(applandValue)) {
             console.error('Invalid value for applandValue');
             applandValue = 0; // or handle it in some way
             } 
             var totalSum = gtotalValue + applandValue;
             $('.gtotal').val(totalSum.toFixed(2)); 
             } else {          
             $('.gtotal').val(gtotal); 
             }
    ...
    var b=parseFloat($('#gtotal').val()-bal_amt);
   ...
   $('#gtotal').val(num.toFixed(2));
   var bal_amt=parseFloat(num-$('.amount_paid').val());
   ...
   $(document).ready(function() {
    $('#land_amt').click(function (event) {
        ...
        var gt = parseFloat($('.gtotal').val()) || 0;
        var lc = parseFloat($('#landing_amount').val()) || 0;
        var bal = parseFloat($('.balance').val()) || 0; // Declare and initialize bal
   
        
        var  alreadycost = parseFloat($('.alreadyaddcost').val()) || 0; // Declare and initialize bal
   
        var alc;  // Declare the variable
   
        if (lc >= 0) {
            // If landing cost is greater than or equal to zero, add it to the balance
            alc = parseFloat(bal) + parseFloat(lc);
        } else {
            // If landing cost is negative, subtract its absolute value from the balance
            alc = parseFloat(bal) - Math.abs(lc);
        }
   
         plc = parseFloat(lc) + parseFloat(alreadycost);
   
         var addlc = parseFloat(gt) + parseFloat(lc);
   
         console.log('addlc: ' + addlc);
         console.log('alc: ' + alc);
   
        // Update the value of the input field with the class '.gtotal'
        $('.gtotal').val(addlc.toFixed(2));
        $('.balance').val(alc.toFixed(2));
   
        $('.alreadyaddcost').val(plc.toFixed(2));
   
        // Assuming your modal has an ID 'myModal', you can hide it like this:
        $('#myModal').modal('hide');
    });
   });
...
<script>
   ...
   $('.modal-backdrop').remove();
   location.reload(); // Reload the page after a delay (2000 milliseconds in this case)
   ...
   $(this).find('.editable-amount-paid input').val(paymentAmount);
     ...
     var b=gtotal - cumulativePayment;
      var Test = document.getElementById('my_bal_1').value = b.toFixed(2);
...
<script type="text/javascript">
   ...
   $(document).on('click','.delete_service',function (event) {
        ...
        var service_id  =   $(this).closest('tr').find('.dum_invoice').val() ;
        // alert(service_id);
      ...
      dataString[csrfName] = csrfHash;
       $.ajax({
           type:"POST",
           dataType:"json",
           url:"<?php echo base_url(); ?>Cinvoice/delete_additionalcost",
           data:dataString,
           success:function (data1) {
           console.log(data1);
           location.reload();
...
<style>
   ...
   .amount_paidcss:after{
       top: 13px !important;
   }
   .payment_modal_euro:after{
