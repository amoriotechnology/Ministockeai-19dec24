                                    ...
                                    <div class="panel-body">
                                        <?php echo form_open_multipart('User/company_insert');?>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-4">
                                                    <input type="text" tabindex="1" class="form-control" name="company_name" id="company_name" value="<?= (!empty($cmpy_record) ? $cmpy_record[0]['company_name'] : '') ?>" placeholder="Enter your Companyname" required /> </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-sm-3 col-form-label">CompanyEmail<i class="text-danger">*</i></label>
                                                <div class="col-sm-4">
                                                    <input type="text" tabindex="1" value="<?= (!empty($cmpy_record) ? $cmpy_record[0]['email'] : '') ?>" class="form-control" name="email" id="email" required placeholder="Enter your Companyemail" /> </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-sm-3 col-form-label">Mobile<i class="text-danger">*</i></label>
                                                <div class="col-sm-4">
                                                    <input type="number" tabindex="1" value="<?= (!empty($cmpy_record) ? $cmpy_record[0]['mobile'] : '') ?>" class="form-control" name="mobile" id="mobile" required placeholder="Enter your mobile" /> </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-sm-3 col-form-label"><?php echo 'City'; ?><i class="text-danger">*</i></label>
                                                <div class="col-sm-4">
                                                    <input type="text" tabindex="1" value="<?= (!empty($cmpy_record) ? $cmpy_record[0]['c_city'] : '') ?>" class="form-control" name="c_city" id="c_city" required placeholder="Enter your city" oninput="this.value = this.value.replace(/[^A-Za-z ]/g, '')"/>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-sm-3 col-form-label"><?php echo 'State'; ?><i class="text-danger">*</i></label>
                                                <div class="col-sm-4">
                                                    <input type="text" tabindex="1" value="<?= (!empty($cmpy_record) ? $cmpy_record[0]['c_state'] : '') ?>" class="form-control" name="c_state" id="c_state" required placeholder="Enter your state" oninput="this.value = this.value.replace(/[^A-Za-z ]/g, '')"/>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-4">
                                                    <input type="text" tabindex="1" value="<?= (!empty($cmpy_record) ? $cmpy_record[0]['address'] : '') ?>" class="form-control" name="address" id="address" placeholder="Enter your address" /> </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-sm-3 col-form-label">Website<i class="text-danger">*</i></label>
                                                <div class="col-sm-4">
                                                    <input type="text" tabindex="1" value="<?= (!empty($cmpy_record) ? $cmpy_record[0]['website'] : '') ?>" class="form-control" name="website" id="website" placeholder="Enter your website" required /> </div>
                                            </div>
                                            <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-4">
                                                    <input type="text" tabindex="1" value="<?= (!empty($cmpy_record) ? $cmpy_record[0]['subscription_fees'] : ''); ?>" class="form-control" name="subscription_fees" id="subscription_fees" placeholder="Enter subscription fees" /> </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-sm-3 col-form-label">Payment Follow-Up Mail<i class="text-danger">*</i></label>
                                                <div class="col-sm-4">
                                                    <input type="email" tabindex="1" value="<?= (!empty($cmpy_record) ? $cmpy_record[0]['payment_mail'] : ''); ?>" class="form-control" name="mail" id="follow_up_mail" placeholder="Enter your Email address" /> </div>
                                            </div>
                                            <hr>
                                            <div class="form-group row">
                                                <label class="col-sm-3 col-form-label">Username<i class="text-danger">*</i></label>
                                                <div class="col-sm-4">
                                                    <input required type="text" value="<?= (!empty($user_record) ? $user_record[0]['username'] : ''); ?>" tabindex="1" class="form-control" name="username" id="username" placeholder="Enter your username" /> </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="password" class="col-sm-3 col-form-label">
                                                    <?php echo display('password') ?> <i class="text-danger">*</i></label>
                                                <div class="col-sm-4">
                                                    <input type="password" tabindex="4" value="<?= (!empty($cmpy_record) ? $cmpy_record[0]['password'] : ''); ?>" ramji="" class="form-control" id="password" required name="password" placeholder="<?php echo display('password') ?>" /> </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="address" class="col-sm-3 col-form-label">Email<i class="text-danger">*</i></label>
                                                <div class="col-sm-4">
                                                    <input type="email" tabindex="1" value="<?= (!empty($user_record) ? $user_record[0]['email_id'] : ''); ?>" class="form-control" name="user_email" required id="user_email" placeholder="Enter your useremail" /> </div>
                                            </div>
                                            <div class="form-group row">
