...
<div class="qq4">
    ...
    <input type="checkbox" name="quarter[]" <?php echo $isQ4 ? 'checked' : ''; ?>>
        ...
        <div class="Address-text">
          <input type="text" value="<?php echo $get_cominfo[0]['address']; ?>" />
        </div>
        <div class="city-text">
          <input type="text" value="<?php echo $get_cominfo[0]['c_city']; ?>" />
        </div>
        <div class="state-text">
          <input type="text" value="<?php echo $get_cominfo[0]['c_state']; ?>" />
        </div>
        <div class="zipcode-text">
          <input type="text" value=" <?php echo $get_cominfo[0]['c_zipcode']; ?>" />
        </div>
        <div class="country">
