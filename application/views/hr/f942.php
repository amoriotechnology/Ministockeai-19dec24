...
<div class="Address-text">
        ...
        <div class="city-text">
          <input type="text" value="<?= (!empty($get_cominfo) ? $get_cominfo[0]['c_city'] : $get_address[1]); ?>" />
        </div>
        <div class="state-text">
          <input type="text" value="<?= (!empty($get_cominfo) ? $get_cominfo[0]['c_state'] : $get_address[2]); ?>" />
        </div>
        <div class="zipcode-text">
          <input type="text" value=" <?= (!empty($get_cominfo) ? $get_cominfo[0]['c_zipcode'] : $get_address[3]); ?>" />
        </div>
                <div class="country">
...
?>
            ...
            <div class="page-3" id="three">
                ...
                <div class="pre-ein">
                    <input type="text" value="<?= $get_cominfo[0]['Federal_Pin_Number']; ?>" />
                </div>
                <div class="pre-phone">
                    <input type="text" value="" />
                </div>
            ...
            <div class="page-5" id="five">
                ...
                <div class="dollar">
                    <input type="text" value="$<?php echo $inter; ?>" />
                </div>
                <div class="cent">
                    <input type="text" value="<?php echo $decimal; ?>" />
                </div>
