...
public function get_products() {
        ...
        join
        product_category b 
        on b.category_name=a.category_name
 ...
 public function sales_product_all() {
     ...
     $this->db->select('a.product_id,a.product_name,COUNT(*) as available ,b.p_quantity');
        ...
        $this->db->group_by('a.product_id,a.product_name,b.p_quantity'); 
    ...
    $this->db->group_by('a.bundle_no'); 
     $query = $this->db->get();
        ...
        public function expense_product_all() {
            $this->db->select('a.product_id,COUNT(*) as available,b.p_quantity');
        $this->db->from('product_purchase_details a');
        $this->db->join('product_information b', 'b.product_id = a.product_id');
      $this->db->group_by('a.product_id,b.p_quantity'); 
       // $this->db->where('a.created_by',$this->session->userdata('user_id'));
        $query = $this->db->get();
