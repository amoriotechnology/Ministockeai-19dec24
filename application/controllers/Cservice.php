...
class Cservice extends CI_Controller {
    ...
    function __construct() {
        ...
        parent::__construct(); $this->load->database('mini_stockeai',true);
    ...
    public function index() {
       ...
       public function add_content() {
        ...
        $content = $this->lservice->content_add_form();
    ...
    public function insert_content() {
       ...
       $data['created_at'] = date('Y-m-d H:i:s');
        ...
        $result = $this->Service->content_entry($data);
        ...
        if ($result == TRUE) {
            ...
            $this->session->set_userdata(array('message' => display('successfully_added')));
                ...
                redirect(base_url('Cservice/help_desk'));
